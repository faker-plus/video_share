...
import com.video.dao.sqlprovider.FileSqlProvider;
...
public interface FileDAO {
    ...
    /**
     * Obtain file number through local path
     *
     * @param visitUrl Local path
     *
     * @return Number
     */
